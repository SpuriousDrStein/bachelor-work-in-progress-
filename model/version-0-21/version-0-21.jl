...
init_params =   Dict("NETWORK_SIZE"                 => FloatN(3),
                ...
                "MAX_PRIORS"                        => 3,
                "MAX_POSTERIORS"                    => 3,
                "NEURON_INIT_INTERVAL"              => 500,
                "MIN_AP_DEN_INIT_INTERVAL"          => 150, # a minimum to negate the possibility of calling the add_dendrite or add_axon_point function every timestep
