...
init_params =   Dict("MAX_NEURON_LIFETIME"          => FloatN(100000),
                ...
                "DATA_INPUT_SIZE"                   => 4,
                "DATA_OUTPUT_SIZE"                  => 2,
                "OUTPUT_SCALE"                      => 30, # coefficient to scale output of dna prediction on to create a more truthfull reconstruction of the high variance space that is the networks parameters
                "LATENT_SIZE"                       => 30,
